...
runProcess = cms.PSet(
    ...
    input = cms.untracked.vstring("/afs/cern.ch/work/v/vischia/public/miniaod/Run2015D_SingleMuon_MINIAOD_05Oct2015-v1_10000_12AB49B0-886F-E511-826F-0025905B855E.root"),
    #outfile = cms.string("/afs/cern.ch/work/v/vischia/private/code/CMSSW_7_4_14/src/UserCode/llvv_fwk/Test_Data_RunD.root"),
    outfile = cms.string("/afs/cern.ch/user/o/otoldaie/work/private/CMSSW_7_4_14/src/UserCode/llvv_fwk/test/out_data/Test_Data_RunD_2.root"),
    isMC = cms.bool(False),
